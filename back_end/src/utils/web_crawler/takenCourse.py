...
def rec(dic, rtnList, takenList):
    ...
    for key in dic:
        d1 = dic[key]
        if "GE" in key:
            ge += checkGE(dic, key, json.load(open("/Users/leng/Desktop/CSE110/parse/ge/Warren.json"))) # warren college json file
        elif "needs" in d1.keys():
            if "Elective" in key:
                potentialCourses = process("/Users/leng/Desktop/CSE110/parse/bensen/cse.json", d1["course_needs"]) 
