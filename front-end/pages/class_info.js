...
// Styles
import styles from '../styles/class_info.module.css'
    ...
    return (
        <>
            ...
            <Container>
                ...
                <div className={styles.item}>Spring 2020</div>
                <div className={styles.item}>Winter 2020</div>
                <div className={styles.item}>Fall 2019</div>
                <div className={styles.item}>Spring 2019</div>
                <div className={styles.item}>Winter 2019</div>
                <div className={styles.item}>Fall 2018</div>
                <div className={styles.item}>Spring 2018</div>
                <div className={styles.item}>Winter 2018</div>
                <div className={styles.item}>Fall 2017</div>
            </div>
            </Container>   
        </>
    )
